...
public enum ProblemCode {
    ...
    enlv1s2c3jy2(ChapterCode.enlv1s2c3),
    enlv1s2c3jy3(ChapterCode.enlv1s2c3),
    enlv1s2c3jy4(ChapterCode.enlv1s2c3),
    enlv1s2c3jy5(ChapterCode.enlv1s2c3),
     ...
     */
    // Chapter 1
    enlv1s3c1kc1(ChapterCode.enlv1s3c1),
    enlv1s3c1kc2(ChapterCode.enlv1s3c1),
    enlv1sec1jy1(ChapterCode.enlv1s3c1),
    enlv1s3c1jy2(ChapterCode.enlv1s3c1),
    enlv1s3c1sh1(ChapterCode.enlv1s3c1),
    ...
    // Chapter 3
    enlv1s3c3kc1(ChapterCode.enlv1s3c3),
    enlv1s3c3kc2(ChapterCode.enlv1s3c3),

    /**
     * Level 1: Subject 4
     */
    // Chapter 1
    enlv1s4c1jy1(ChapterCode.enlv1s4c1),
    enlv1s4c1jy2(ChapterCode.enlv1s4c1),
    enlv1s4c1jy3(ChapterCode.enlv1s4c1),
    enlv1s4c1jy4(ChapterCode.enlv1s4c1),
    // Chapter 2
